...
try:
    ...
    version = safetar.__version__
    project = safetar.__title__
    copyright = safetar.__copyright__
    author = safetar.__author__
except ImportError:
    version = "0.1"
    project = "safetar"
...
epub_identifier = "https://github.com/barseghyanartur/safetar"  # URL or ISBN
epub_scheme = "URL"  # or "ISBN"
epub_uid = "https://github.com/barseghyanartur/safetar"
