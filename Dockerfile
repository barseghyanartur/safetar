# Build:  docker build -t safetar-test .
# Test:   docker run --rm safetar-test
# Env:    docker run --rm safetar-test -e py312
# Shell:  docker run --rm -it --entrypoint bash safetar-test
